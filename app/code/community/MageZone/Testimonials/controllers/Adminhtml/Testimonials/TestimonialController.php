 ...
 */
class MageZone_Testimonials_Adminhtml_Testimonials_TestimonialController extends Mage_Adminhtml_Controller_Action {

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('magezone/testimonials/testimonial')
	...
	public function editAction() {
		...
		if ($testimonialModel->getId() || $testimonialId == 0) {
			...
			$this->loadLayout();
			$this->_setActiveMenu('magezone/testimonials/testimonial');
